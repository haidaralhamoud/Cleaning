...
def get_dashboard_items() -> List[DashboardItem]:
    return [
        ...
        DashboardItem("business-categories", home_models.BusinessMainCategory, "Business Categories", "fa-solid fa-tags"),
        ...
        DashboardItem("service-room-options", home_models.ServiceRoomOption, "Service Room Options", "fa-solid fa-table-cells-large"),
