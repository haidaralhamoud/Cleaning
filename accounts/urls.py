...
urlpatterns = [
    ...
    path("sign_up/verify/", views.signup_verify, name="signup_verify"),
    ...
    path("payment-billing/invoice/<int:invoice_id>/download/", views.download_invoice_pdf, name="download_invoice_pdf"),
    ...
    path("provider/booking/<str:booking_type>/<int:booking_id>/checklist/<int:item_id>/", views.provider_checklist_item_update, name="provider_checklist_item_update"),
